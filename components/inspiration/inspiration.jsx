...
const Inspiration = () => {
  return (
    <div className="md:h-[400px] h-[300px] bg-center px-4 md:px-0	flex items-center justify-center bg-fixed bg-no-repeat bg-cover md:bg-cover bg-[url('/globe.gif')] md:bg-[url('/inspiration.svg')]  w-full">
